...
#PBS -j oe
#PBS -N eu_es2_ana
#PBS -o /scratch/bogdanm/pbs/eu_es2_ana.log
#PBS -m ae
...
kinematic_project = mGNSS_class(project_name = 'eu_es2_ce',
                                staDb_path = '/scratch/bogdanm/tmp_GipsyX/bigf_tmpX//staDb/eu_es2_ce/eu_es2_ce.staDb',
