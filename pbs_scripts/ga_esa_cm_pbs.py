...
gnss_products_dir = '/scratch/bogdanm/Products/IGS_GNSS_Products/init/esa_cm' #we should use COD MGEX, ESA and GFZ later
...
for i in range(len(stations_list_arrays)):
    ...
    qsub_python_code(code,name='{}{}'.format(project_name,str(i)),email='bogdan.matviichuk@utas.edu.au',cleanup=False,pbs_base = pbs_base,walltime='12:00:00')
