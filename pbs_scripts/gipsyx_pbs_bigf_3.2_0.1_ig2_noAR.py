...
#PBS -j oe
#PBS -o /scratch/bogdanm/output_bigf3.2_igs_noAR.txt
#PBS -m ae
#PBS -M bogdan.matviichuk@utas.edu.au
#PBS -N gx_bigf3.2_igs_noAR
...
kinematic_project = mGNSS_class(project_name = 'bigf_ig2',
                            ...
                            rate = 300,
                            gnss_products_dir = '/scratch/bogdanm/Products/IGS_GNSS_Products/init/ig2/',
