...
#PBS -j oe
#PBS -o /scratch/bogdanm/out_21_3.2_es2_p2
#PBS -m ae
...
stations_list=['CHIO','CARI', 'SWAS', 'ANLX','HERT','LOFT','WEAR','CAMO','BRAE','BRST','ZIM2']
years_list=[2010,2011,2012,2013];num_cores = 28



kinematic_project = mGNSS_class(project_name = '21_es2_ce_2',
