...
#PBS -j oe
#PBS -o /scratch/bogdanm/output_bigf3.2_gr2_p2.txt
#PBS -m ae
...
'''Kunanyi. This is part two of the project'''
...
kinematic_project = mGNSS_class(project_name = 'bigf_gr2_2',
                            ...
                            rate = 300,
                            gnss_products_dir = '/scratch/bogdanm/Products/IGS_GNSS_Products/init/gr2/',
