...
#PBS -j oe
#PBS -o /scratch/bogdanm/output_bigf3.2_jp2_noAR.txt
#PBS -m ae
#PBS -M bogdan.matviichuk@utas.edu.au
#PBS -N gx_bigf3.2_jp2_noAR
...
kinematic_project = mGNSS_class(project_name = 'bigf_jp2',
                            ...
                            rate = 300,
                            gnss_products_dir = '/scratch/bogdanm/Products/IGS_GNSS_Products/init/jp2/',
                            ...
                            pos_s = 3.2, wetz_s=0.1,PPPtype='kinematic',tqdm=False,ambres=False)
