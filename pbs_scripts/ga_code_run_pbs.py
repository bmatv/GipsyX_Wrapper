...
'''Execution part here
GA GPS continuous stations 2014-2020+ (NOW) (134 good stations)''' 
stations_list= ['ALBU', 'ALBY', 'ALIC', 'ANDA',
                'ANTW', 'APSL', 'ARMD', 'BALN', 'BBOO', 
                ...
                'PTSV', 'PUTY', 'RAVN', 'RGLN', 'RHPT', 'ROBI', 'SA45',
                'SEAL', 'SEMR', 'SNGO', 'SPBY', 'SPWD', 'SRVC', 'STNY', 'STR1',
                'STR2', 'STR3', 'TAMW', 'TARE', 'TATU', 'TBOB', 'TELO', 'TID1',
                'TOW2', 'TURO', 'ULLA', 'UNDE', 'VLWD', 'WAGN', 'WARA',
                'WFAL', 'WGGA', 'WILU', 'WLGT', 'WMGA', 'WOTG',
                'WWLG', 'WYCH', 'WYNG', 'YAR2', 'YARR', 'YEEL', 'YELO']

years_list=[2014,2015,2016,2017,2018,2019,2020];num_cores = 28
