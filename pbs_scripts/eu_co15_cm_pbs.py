...
project_name = 'eu_cod_cm'
ionex_type='cod' #igs ionex map igsg2260.15i is missing data
gnss_products_dir = '/scratch/bogdanm/Products/CODE/init/co2015_cm' #we should use COD MGEX, ESA and GFZ later
...
for i in range(len(stations_list_arrays)):
    ...
    qsub_python_code(code,name='{}{}{}'.format(project_name,str(ElMin) if ElMin != 7 else '',str(i)),email='bogdan.matviichuk@utas.edu.au',cleanup=False,pbs_base = pbs_base, walltime='03:00:00')