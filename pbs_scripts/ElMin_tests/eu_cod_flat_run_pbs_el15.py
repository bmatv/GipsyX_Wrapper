...
for i in range(len(stations_list_arrays)):
    ...
    qsub_python_code(code,name='{}el15_{}'.format(project_name,str(i)),email='bogdan.matviichuk@utas.edu.au',cleanup=False,pbs_base = '/scratch/bogdanm/pbs')
