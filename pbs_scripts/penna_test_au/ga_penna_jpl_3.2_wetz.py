...
for i in range(len(penna_wetz_list)):
    ...
    qsub_python_code(code,name='{}wetz_{}'.format(project_name,str(i)),email='bogdan.matviichuk@utas.edu.au',cleanup=False,pbs_base = pbs_base, walltime = '02:00:00')
