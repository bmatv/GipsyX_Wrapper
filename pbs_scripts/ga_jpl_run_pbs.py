...
'''Execution part here
GA GPS continuous stations 2013-2020+ (NOW) (good 139 stations)''' 
stations_list= ['ALBU', 'ALBY', 'ALIC', 'ANDA', #'00NA' and '01NA' removed due to SEPPOLANT_X_MF, '02NA', 'ADEL' removed
                'ANTW', 'APSL', 'ARMD', 'BALN', 'BBOO', 'BDST', #'BAIR' removed as no files available, 'BDLE' removed
                'BEE2', 'BEEC', 'BEGA', 'BNDY', 'BRBA', 'BRO1', 'BUR2', 'BURA',
                'CBLT', 'CEDU', 'CLAC', 'CLEV', 'CNDO', 'COFF', 'COMA', 'COOB',
                'CSNO', 'CWN2', 'CWRA', 'DARW', 'DBBO', 'DKSN', 'DODA', # 'DWNI' removed
                'ECHU', 'ESPA', 'GABO', 'GATT', 'GFTH', 'GLBN', 'GLEN', 'GLIN',
                'GONG', 'GORO', 'HATT', 'HOB2', 'HYDN', 'IHOE', #'HIL1', 'HNIS' removed
                ...
                'PTSV', 'PUTY', 'RAVN', 'RGLN', 'RHPT', 'ROBI', 'SA45', #'PTLD',
                'SEAL', 'SEMR', 'SNGO', 'SPBY', 'SPWD', 'SRVC', 'STNY', 'STR1',
                'STR2', 'STR3', 'TAMW', 'TARE', 'TATU', 'TBOB', 'TELO', 'TID1',
                'TOW2', 'TURO', 'ULLA', 'UNDE', 'VLWD', 'WAGN', 'WARA', #'TOOW', 
                'WFAL', 'WGGA', 'WILU', 'WLGT', 'WMGA', 'WOTG', #'WEIP', 'WOOL',
