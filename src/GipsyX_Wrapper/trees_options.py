penna_k_randomwalk = [
    [
        ...
        # ['GRN_STATION_CLK_WHITE:Trop:GradNorth:StochasticAdj', '3.0e8 3.0e8 $GLOBAL_DATA_RATE WHITENOISE'], #Very bad result
...
_pseudo_range_glo = [
    ...
    [
        "Global:DataTypes:IonoFreeC_1P_2P:DataLinkSpec_PC_GLO:DataBias:StochasticAdj",
        "1.0e4 3.40e-4 DATADRIVEN RANDOMWALK",
    ],
...
_carrier_phase_glo = [
    ...
    [
        "Global:DataTypes:IonoFreeL_1P_2P:DataLinkSpec_LC_GLO:DataBias:StochasticAdj",
        "3.0e8 3.0e8 DATADRIVEN WHITENOISE",
    ],
...
_carrier_phase_gps = [
    ...
    [
        "Global:DataTypes:IonoFreeL_1P_2P:DataLinkSpec_LC_GPS:DataBias:StochasticAdj",
        "3.0e8 3.0e8 DATADRIVEN WHITENOISE",
    ],
...
_tides_all_on = [
    ...
    ["GRN_STATION_CLK_WHITE:Tides:OceanLoad", "On"],
]  # turning all components on manually

_tides_otl_off = [
    ["GRN_STATION_CLK_WHITE:Tides:All", "On"],
    ["GRN_STATION_CLK_WHITE:Tides:SolidTide", "On"],
    ["GRN_STATION_CLK_WHITE:Tides:PoleTide", "On"],
    ["GRN_STATION_CLK_WHITE:Tides:OceanLoad", "Off"],
]  # turning all components on manually
